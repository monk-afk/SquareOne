...
- [ ] filterplus/init.lua -- minor code improvements to filter load order
...
> May 13
- [ ] shopsign/init.lua -- bugfix and texturing
- [ ] exp/init.lua -- removed garbage noclip detection
- [ ] squareone_items/anti_noclip.lua -- silence reporting
